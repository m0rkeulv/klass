...
//                .prettyPeek()
    ...
    public void restServiceVariantIncludeFutureVersionsJSON() {
        given().port(port).accept(ContentType.JSON).param("variantName", "Variant - Tilleggsinndeling for familier")
                .param("from", "2014-01-01").param("includeFuture", true)
                .get(REQUEST_WITH_ID_AND_VARIANT, familieGrupperingCodelist.getId())
//                .prettyPeek()
                .then()
                .statusCode(HttpStatus.OK.value())
                ...
                .body("codes[0].presentationName", equalTo(""))
                .body("codes[0].validFromInRequestedRange", equalTo("2014-01-01"))
                .body("codes[0].validToInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
                //2
                .body("codes[1].code", equalTo("A_"))
                .body("codes[1].level", equalTo("2"))
                .body("codes[1].name", equalTo("Enpersonfamilie"))
                ...
                .body("codes[1].presentationName", equalTo(""))
                .body("codes[1].validFromInRequestedRange", equalTo("2014-01-01"))
                .body("codes[1].validToInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
                //..
                //6
                ...
                .body("codes[5].validFromInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
                ...
                .body("codes[7].validFromInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
    ...
    public void restServiceVariantDateRangeJSON() {
        given().port(port).accept(ContentType.JSON).param("variantName", "Variant - Tilleggsinndeling for familier")
                .param("from", "2014-01-01").param("to", "2040-01-01")
                .get(REQUEST_WITH_ID_AND_VARIANT, familieGrupperingCodelist.getId())
//                .prettyPeek()
                .then()
                .statusCode(HttpStatus.OK.value())
    ...
    public void restServiceVariantDateRangeIncludeFutureVersionsJSON() {
        given().port(port).accept(ContentType.JSON).param("variantName", "Variant - Tilleggsinndeling for familier")
                .param("from", "2014-01-01").param("to", TestDataProvider.TWENTY_YEARS_LATER_DATE).param("includeFuture", true)
                .get(REQUEST_WITH_ID_AND_VARIANT, familieGrupperingCodelist.getId())
//                .prettyPeek()
                .then()
                .statusCode(HttpStatus.OK.value())
                ...
                .body("codes[7].presentationName", equalTo(""))
                .body("codes[7].validFromInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
                .body("codes[7].validToInRequestedRange", equalTo(TestDataProvider.TWENTY_YEARS_LATER_DATE));
...
//                .prettyPeek()
                ...
                .body(XML_CODES + "[0].presentationName", equalTo(""))
                .body(XML_CODES + "[0].validFromInRequestedRange", equalTo("2014-01-01"))
                .body(XML_CODES + "[0].validToInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
                //...
                //8
                ...
                .body(XML_CODES + "[7].validFromInRequestedRange", equalTo(TestDataProvider.TEN_YEARS_LATER_DATE))
